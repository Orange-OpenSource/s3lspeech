...
class BlockConfig:
    def __init__(self, cfg=None):
        ...
        self.use_flash_attn: bool = True # wether to use flash attention layers

        self.encoder_embed_dim: int = 512     # encoder embedding dimension
        self.encoder_ffn_embed_dim: int = 4 * self.encoder_embed_dim  # dimension for FFN
